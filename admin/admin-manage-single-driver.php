    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Cleaner</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group" style="display:none">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" value="Cleaner" name="u_category">
            </div>
            ...
            <button type="submit" name="update_user" class="btn btn-success">Update Cleaner</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
