      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Place In Charge</label>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="u_addr" id="exampleFormControlSelect1">
                <?php

                $ret="SELECT * FROM tms_user  "; //sql code to get to all vehicles
                $stmt= $mysqli->prepare($ret) ;
                $stmt->execute() ;//ok
                $res=$stmt->get_result();
                $cnt=1;
                ...
                {
                ?>
                <option><?php echo $row->u_addr;?></option>
                <?php }?> 
              </select>
            </div>
