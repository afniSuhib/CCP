...
<head>
  ...
  <meta name="description" content="Clean Connect Pro,JTMK,PMU">
  <meta name="author" content="MartDevelopers">

  <title>Clean Connect Pro - Admin Dashboard</title>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $result ="SELECT count(*) FROM tms_user where u_category = 'Cleaner'";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $driver;?></span> Cleaner</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $vehicle;?></span> Location</div>
              </div>
