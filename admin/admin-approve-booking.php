        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="email" readonly value="<?php echo $row->u_location;?>" class="form-control" name="u_location">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Person In Charge</label>
                <input type="email" readonly value="<?php echo $row->u_pic;?>" class="form-control" name="u_pic">
            </div>
